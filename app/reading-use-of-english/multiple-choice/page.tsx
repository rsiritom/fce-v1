...
import { multipleChoiceSets } from "@/lib/data"
...
export default function MultipleChoicePage() {
  return (
    <div className="container max-w-4xl py-6">
      ...
      <p className="mb-6">
        Practice your reading comprehension by reading texts and answering multiple choice questions.
      </p>
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {multipleChoiceSets.map((set) => (
          <Card key={set.id}>
            ...
            <CardContent>
              <Link href={`/reading-use-of-english/multiple-choice/${set.id}`}>
                <Button>Start</Button>
              </Link>
            </CardContent>
          </Card>
